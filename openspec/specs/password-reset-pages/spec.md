# password-reset-pages Specification

## Purpose
Lets anyone who has forgotten their password recover access through two public screens: requesting a reset link by email, and setting a new password from that link.
