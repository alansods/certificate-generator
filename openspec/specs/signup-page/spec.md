...
## Purpose
Lets anyone create a USER-role account through a public sign-up screen and be signed in immediately, without an administrator provisioning the account first.
